...
* Из Packagist:
    ...
    * Выполнить команду composer require Yukiowtnb/guess-number; Перейти в каталог vendor/bin; Запустить Командную строку и ввести "php guess-number.php".
    * Ссылки Packagist: yukio/guess-number
